module.exports = class Data1694444042360 {
    name = 'Data1694444042360'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "metadata" ("id" character varying NOT NULL, "contract_address" text NOT NULL, "content" bytea NOT NULL, CONSTRAINT "PK_56b22355e89941b9792c04ab176" PRIMARY KEY ("id"))`)
