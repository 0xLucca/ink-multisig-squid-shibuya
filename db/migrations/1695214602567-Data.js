module.exports = class Data1695214602567 {
    name = 'Data1695214602567'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "external_transaction_data" ("id" character varying NOT NULL, "tx_hash" text NOT NULL, "method_name" text NOT NULL, "args" bytea NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, CONSTRAINT "PK_caf6c1ca405ec201369711fe6bf" PRIMARY KEY ("id"))`)
